...
namespace TMUnity
{
    ...
    public class Interpolator : MonoBehaviour
    {
        ...
        public Vector3 LocalPositionVelocity { get; private set; }
        ...
        public void Update()
        {
            ...
            if (AnimatingLocalPosition)
            {
                ...
                if ((targetLocalPosition - newPosition).sqrMagnitude <= smallNumber)
                {
                    // Snap to final position
                ...
                //calculate interpolatedVelocity and store position for next frame
                LocalPositionVelocity = oldLocalPosition - newPosition;
                oldLocalPosition = newPosition;
            }
